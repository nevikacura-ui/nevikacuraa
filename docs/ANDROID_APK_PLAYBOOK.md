...
android {
    ...
    defaultConfig {
        ...
        manifestPlaceholders = [
            ...
            defaultUrl: "https://premium-rx-portal.preview.emergentagent.com",
            launcherName: "Nevika Cura",
            assetStatements: '[{ "relation": ["delegate_permission/common.handle_all_urls"], "target": { "namespace": "web", "site": "https://premium-rx-portal.preview.emergentagent.com" } }]'
        ]
    }
...
- **Production URL**: `https://premium-rx-portal.preview.emergentagent.com`
