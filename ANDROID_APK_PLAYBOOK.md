...
android {
    ...
    defaultConfig {
        ...
        manifestPlaceholders = [
            ...
            defaultUrl: "https://portal-recovery.preview.emergentagent.com",
            launcherName: "Nevika Cura",
            assetStatements: '[{ "relation": ["delegate_permission/common.handle_all_urls"], "target": { "namespace": "web", "site": "https://portal-recovery.preview.emergentagent.com" } }]'
        ]
    }
...
- **Production URL**: `https://portal-recovery.preview.emergentagent.com`
