...
android {
    ...
    defaultConfig {
        ...
        manifestPlaceholders = [
            ...
            defaultUrl: "https://nevika-cura-portal.preview.emergentagent.com",
            launcherName: "Nevika Cura",
            assetStatements: '[{ "relation": ["delegate_permission/common.handle_all_urls"], "target": { "namespace": "web", "site": "https://nevika-cura-portal.preview.emergentagent.com" } }]'
        ]
    }
...
- **Production URL**: `https://nevika-cura-portal.preview.emergentagent.com`
