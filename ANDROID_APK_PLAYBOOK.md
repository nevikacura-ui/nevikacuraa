...
android {
    ...
    defaultConfig {
        ...
        manifestPlaceholders = [
            ...
            defaultUrl: "https://unified-login-fix.preview.emergentagent.com",
            launcherName: "Nevika Cura",
            assetStatements: '[{ "relation": ["delegate_permission/common.handle_all_urls"], "target": { "namespace": "web", "site": "https://unified-login-fix.preview.emergentagent.com" } }]'
        ]
    }
...
- **Production URL**: `https://unified-login-fix.preview.emergentagent.com`
