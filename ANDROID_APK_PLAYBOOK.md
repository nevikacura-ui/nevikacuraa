...
android {
    ...
    defaultConfig {
        ...
        manifestPlaceholders = [
            ...
            defaultUrl: "https://multi-portal-session.preview.emergentagent.com",
            launcherName: "Nevika Cura",
            assetStatements: '[{ "relation": ["delegate_permission/common.handle_all_urls"], "target": { "namespace": "web", "site": "https://multi-portal-session.preview.emergentagent.com" } }]'
        ]
    }
...
- **Production URL**: `https://multi-portal-session.preview.emergentagent.com`
