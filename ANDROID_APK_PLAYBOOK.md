...
android {
    ...
    defaultConfig {
        ...
        manifestPlaceholders = [
            ...
            defaultUrl: "https://faithcare-review-hub.preview.emergentagent.com",
            launcherName: "Nevika Cura",
            assetStatements: '[{ "relation": ["delegate_permission/common.handle_all_urls"], "target": { "namespace": "web", "site": "https://faithcare-review-hub.preview.emergentagent.com" } }]'
        ]
    }
...
- **Production URL**: `https://faithcare-review-hub.preview.emergentagent.com`
