...
const Home = () => {
  ...
  // Splash/Login Overlay - Mandatory login with Skip option
  if (showSplash && !user) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-teal-50/30 relative overflow-hidden">
        ...
        <div className="absolute top-4 right-4 z-50">
          <Button
            ...
            className="text-slate-500 hover:text-slate-700 hover:bg-white/50 rounded-full px-4"
          >
            Skip
        ...
        <div className="min-h-screen flex flex-col items-center justify-center px-6 py-12">
          ...
          <div className="text-center max-w-md mb-10">
            ...
            <p className="text-slate-600 text-base sm:text-lg">
              Book doctors, order medicines, get lab tests - all in one trusted platform.
            </p>
          </div>
          ...
          <div className="flex flex-wrap justify-center gap-3 mb-10 max-w-sm">
            <div className="flex items-center gap-2 px-4 py-2 bg-white/80 backdrop-blur rounded-full border border-slate-200 shadow-sm">
              ...
              <span className="text-sm text-slate-700">Book Doctors</span>
            </div>
            <div className="flex items-center gap-2 px-4 py-2 bg-white/80 backdrop-blur rounded-full border border-slate-200 shadow-sm">
              <Pill className="w-4 h-4 text-orange-500" />
              <span className="text-sm text-slate-700">Order Medicines</span>
            </div>
            <div className="flex items-center gap-2 px-4 py-2 bg-white/80 backdrop-blur rounded-full border border-slate-200 shadow-sm">
              <TestTube className="w-4 h-4 text-blue-500" />
              <span className="text-sm text-slate-700">Lab Tests</span>
            </div>
          </div>
          ...
          <Button
            ...
            className="w-full max-w-xs rounded-full bg-gradient-to-r from-teal-500 to-cyan-500 hover:from-teal-600 hover:to-cyan-600 shadow-lg shadow-teal-500/30 text-base py-6 transition-all duration-300 hover:scale-105"
          >
            Login / Sign Up
