...
const Home = () => {
  ...
  return (
    <div className={`min-h-screen bg-gradient-to-br ${currentTheme.bgGradient} relative font-body transition-all duration-500`} style={{ contentVisibility: 'auto' }}>
        ...
        <div className={`${currentTheme.isLight ? 'bg-slate-50/50' : 'bg-white/10 backdrop-blur-sm'}`}>
          <div className="max-w-7xl mx-auto px-4">
            <div className="flex items-center gap-2 py-2 overflow-x-auto scrollbar-hide">
              ...
              {/* DiaGyn - Navigate directly to /diagyn */}
              <button
                onClick={() => navigate('/diagyn')}
                className="flex-shrink-0 px-4 py-2 rounded-full flex items-center gap-2 transition-all bg-white border border-slate-200 text-slate-700 hover:border-teal-300 hover:shadow-md"
              ...
              {/* Proton - Navigate directly to /proton */}
              <button
                onClick={() => navigate('/proton')}
                className="flex-shrink-0 px-4 py-2 rounded-full flex items-center gap-2 transition-all bg-white border border-slate-200 text-slate-700 hover:border-blue-300 hover:shadow-md"
      ...
      {activeService !== 'home' && (
        <div className="py-6 px-4">
          <div className="max-w-5xl mx-auto">
            ...
            <div className={`rounded-2xl p-6 mb-6 bg-white/80 backdrop-blur-sm shadow-lg border ${
              activeService === 'diagyn' ? 'border-teal-200' :
              activeService === 'proton' ? 'border-blue-200' :
              'border-orange-200'
            }`}>
              <div className="flex items-center justify-between">
                <div>
                  <h1 className={`text-2xl font-bold ${
                    activeService === 'diagyn' ? 'text-teal-700' :
                    activeService === 'proton' ? 'text-blue-700' :
                    'text-orange-700'
                  }`}>
                    {activeService === 'diagyn' ? 'DiaGyn Clinic' :
                     activeService === 'proton' ? 'Proton Diagnostics' :
                     'Orange Pharmacy'}
                  </h1>
                  <p className="text-slate-600 mt-1">
                    {activeService === 'diagyn' ? 'Book appointments with our specialists' :
                     activeService === 'proton' ? 'Lab tests with home sample collection' :
                     'Order medicines with quick delivery'}
                  </p>
                </div>
                <Button 
                  onClick={() => navigate(`/${activeService === 'pharmacy' ? 'pharmacy' : activeService}`)}
                  className={`rounded-full px-6 ${
                    activeService === 'diagyn' ? 'bg-teal-600 hover:bg-teal-700' :
                    activeService === 'proton' ? 'bg-blue-600 hover:bg-blue-700' :
                    'bg-orange-500 hover:bg-orange-600'
                  } text-white`}
                >
                  {activeService === 'diagyn' ? 'Book Now' :
                   activeService === 'proton' ? 'Book Tests' :
                   'Order Now'}
                </Button>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {activeService === 'diagyn' && (
                <>
                  <button onClick={() => navigate('/diagyn')} className="p-4 bg-white rounded-xl shadow-sm border border-teal-100 hover:shadow-md transition-all text-center">
                  ...
                  <button onClick={() => navigate('/diagyn?service=sonography')} className="p-4 bg-white rounded-xl shadow-sm border border-teal-100 hover:shadow-md transition-all text-center">
                    <div className="w-12 h-12 mx-auto mb-3 rounded-full bg-pink-100 flex items-center justify-center">
                      <Baby className="w-6 h-6 text-pink-600" />
                    </div>
                    <span className="text-sm font-medium text-slate-700">Sonography</span>
                  </button>
                  <button onClick={() => navigate('/my-orders')} className="p-4 bg-white rounded-xl shadow-sm border border-teal-100 hover:shadow-md transition-all text-center">
                  ...
                  <button onClick={() => navigate('/teleconsult')} className="p-4 bg-white rounded-xl shadow-sm border border-teal-100 hover:shadow-md transition-all text-center">
                    <div className="w-12 h-12 mx-auto mb-3 rounded-full bg-indigo-100 flex items-center justify-center">
                      <Video className="w-6 h-6 text-indigo-600" />
                    </div>
                    <span className="text-sm font-medium text-slate-700">Video Consult</span>
                  </button>
                </>
              )}
              {activeService === 'proton' && (
                <>
                  <button onClick={() => navigate('/proton')} className="p-4 bg-white rounded-xl shadow-sm border border-blue-100 hover:shadow-md transition-all text-center">
                    <div className="w-12 h-12 mx-auto mb-3 rounded-full bg-blue-100 flex items-center justify-center">
                      <FlaskConical className="w-6 h-6 text-blue-600" />
                    </div>
                    <span className="text-sm font-medium text-slate-700">Book Lab Tests</span>
                  </button>
                  <button onClick={() => navigate('/health-packages')} className="p-4 bg-white rounded-xl shadow-sm border border-blue-100 hover:shadow-md transition-all text-center">
                    <div className="w-12 h-12 mx-auto mb-3 rounded-full bg-indigo-100 flex items-center justify-center">
                      <Package className="w-6 h-6 text-indigo-600" />
                    </div>
                    <span className="text-sm font-medium text-slate-700">Health Packages</span>
                  </button>
                  <button onClick={() => navigate('/my-orders')} className="p-4 bg-white rounded-xl shadow-sm border border-blue-100 hover:shadow-md transition-all text-center">
                    <div className="w-12 h-12 mx-auto mb-3 rounded-full bg-purple-100 flex items-center justify-center">
                      <FileText className="w-6 h-6 text-purple-600" />
                    </div>
                    <span className="text-sm font-medium text-slate-700">My Reports</span>
                  </button>
                  <button onClick={() => navigate('/proton')} className="p-4 bg-white rounded-xl shadow-sm border border-blue-100 hover:shadow-md transition-all text-center">
                    <div className="w-12 h-12 mx-auto mb-3 rounded-full bg-green-100 flex items-center justify-center">
                      <HomeIcon className="w-6 h-6 text-green-600" />
                    </div>
                    <span className="text-sm font-medium text-slate-700">Home Collection</span>
                  </button>
                </>
              )}
              {activeService === 'pharmacy' && (
                <>
                  <button onClick={() => navigate('/pharmacy')} className="p-4 bg-white rounded-xl shadow-sm border border-orange-100 hover:shadow-md transition-all text-center">
                    <div className="w-12 h-12 mx-auto mb-3 rounded-full bg-orange-100 flex items-center justify-center">
                      <Pill className="w-6 h-6 text-orange-600" />
                    </div>
                    <span className="text-sm font-medium text-slate-700">Order Medicines</span>
                  </button>
                  <button onClick={() => navigate('/pharmacy?upload=true')} className="p-4 bg-white rounded-xl shadow-sm border border-orange-100 hover:shadow-md transition-all text-center">
                    <div className="w-12 h-12 mx-auto mb-3 rounded-full bg-amber-100 flex items-center justify-center">
                      <Download className="w-6 h-6 text-amber-600" />
                    </div>
                    <span className="text-sm font-medium text-slate-700">Upload Prescription</span>
                  </button>
                  <button onClick={() => navigate('/my-orders')} className="p-4 bg-white rounded-xl shadow-sm border border-orange-100 hover:shadow-md transition-all text-center">
                  ...
                  <button onClick={() => navigate('/quick-reorder')} className="p-4 bg-white rounded-xl shadow-sm border border-orange-100 hover:shadow-md transition-all text-center">
                    <div className="w-12 h-12 mx-auto mb-3 rounded-full bg-green-100 flex items-center justify-center">
                      <ChevronRight className="w-6 h-6 text-green-600" />
                    </div>
                    <span className="text-sm font-medium text-slate-700">Quick Reorder</span>
                  </button>
                </>
              )}
            </div>
      ...
      {/* Main Content - Only show when Home is active */}
      {activeService === 'home' && (
