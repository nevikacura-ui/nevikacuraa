        ...
        {step === 'method-select' && (
          <div className="space-y-4">
            ...
            <button
              ...
              className="w-full p-4 border-2 border-gray-200 bg-white rounded-xl hover:border-gray-300 hover:bg-gray-50 transition-all text-left group"
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500">Quick one-tap sign in</p>
                </div>
              </div>
            </button>
