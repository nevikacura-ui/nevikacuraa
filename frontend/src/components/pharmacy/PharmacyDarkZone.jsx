    ...
    <>
      ...
      <div className="max-w-7xl mx-auto px-4 pt-4 pb-2">
        <button
          ...
          style={{ background: 'linear-gradient(135deg, rgba(251,191,36,0.12) 0%, rgba(249,115,22,0.15) 100%)', border: '1px solid rgba(251,191,36,0.25)' }}
        ...
        >
          ...
          <div className="flex-1 text-left">
            <p className="text-sm font-bold text-white">Upload Prescription & Save</p>
            <p className="text-[10px] text-amber-400/70">We'll add medicines & you get the best price</p>
          </div>
          <span className="px-2.5 py-1 rounded-full text-[10px] font-bold" style={{ background: 'rgba(251,191,36,0.2)', color: '#FBBF24', border: '1px solid rgba(251,191,36,0.3)' }}>Rx</span>
        </button>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-5">
        <div className="grid grid-cols-2 gap-4">
          <button onClick={() => setShowPrescriptionUpload(true)}
            className="bg-white/95 backdrop-blur border border-orange-100/60 rounded-2xl p-4 text-left shadow-sm hover:shadow-md hover:border-orange-300 transition-all hover:scale-[1.02] active:scale-[0.98] group"
          ...
          <button onClick={() => setShowCustomMedicine(true)}
            className="bg-white/95 backdrop-blur border border-violet-100/60 rounded-2xl p-4 text-left shadow-sm hover:shadow-md hover:border-violet-300 transition-all hover:scale-[1.02] active:scale-[0.98] group"
        ...
        <div className="grid grid-cols-2 gap-4 mt-4">
          <a href="/diagyn" className="bg-white/95 backdrop-blur border border-emerald-100/60 rounded-2xl p-4 text-left shadow-sm hover:shadow-md hover:border-emerald-300 transition-all hover:scale-[1.02] active:scale-[0.98] group" data-testid="book-consultation-btn">
            <div className="flex items-center gap-3">
          ...
          <a href="/nutricare" className="bg-white/95 backdrop-blur border border-cyan-100/60 rounded-2xl p-4 text-left shadow-sm hover:shadow-md hover:border-cyan-300 transition-all hover:scale-[1.02] active:scale-[0.98] group" data-testid="healthplus-switch-btn">
            <div className="flex items-center gap-3">
      ...
      <div className="max-w-7xl mx-auto px-4 pb-4">
        <a href="/cura-bonus"
          ...
          style={{ background: 'linear-gradient(135deg, rgba(249,115,22,0.12) 0%, rgba(34,197,94,0.08) 100%)', border: '1px solid rgba(249,115,22,0.2)' }}
          ...
          <div className="flex-1 text-left">
            <p className="text-sm font-bold text-white">CuraBonus Rewards</p>
            <p className="text-[10px] text-orange-300/60">Earn coins on every order. Unlock rewards!</p>
          </div>
          <ChevronRight className="w-4 h-4 text-orange-400/40 flex-shrink-0" />
        </a>
      </div>
      ...
      {!searchQuery && (
        <div className="max-w-7xl mx-auto px-4 pb-4" data-testid="popular-medicines">
          <h3 className="text-white font-bold text-sm mb-3">Popular Medicines</h3>
          <div className="flex gap-2.5 overflow-x-auto pb-1 scrollbar-hide">
            {['Paracetamol 500mg', 'Crocin Advance', 'Dolo 650', 'Azithromycin', 'Cetirizine', 'Pan-D', 'Shelcal 500', 'Vitamin D3'].map((name, i) => (
              <button key={i}
                ...
                className="flex-shrink-0 px-3 py-2 rounded-xl text-[11px] font-medium text-white/70 border border-white/8 bg-white/[0.04] hover:bg-orange-500/10 hover:border-orange-500/30 hover:text-orange-300 transition-all active:scale-95"
      ...
      <div className="sticky top-0 z-40 bg-[#050510]/95 backdrop-blur-md border-b border-white/5 py-2 px-4 safe-area-top">
        <div className="max-w-7xl mx-auto flex items-center justify-center gap-2">
          ...
          <a href="https://wa.me/917039030030?text=Hi%2C%20I%20would%20like%20to%20order%20medicines"
            ...
            className="flex-1 flex items-center justify-center gap-1.5 px-3 py-2.5 bg-emerald-500/20 text-emerald-400 rounded-xl text-sm font-medium hover:bg-emerald-500/30 transition-colors whitespace-nowrap"
            data-testid="chat-pharmacist-btn">
            <MessageCircle className="w-4 h-4" />Chat
          </a>
          <a href="tel:+917039030030"
            className="flex items-center justify-center gap-1.5 px-3 py-2.5 bg-blue-500/20 text-blue-400 rounded-xl text-sm font-medium hover:bg-blue-500/30 transition-colors whitespace-nowrap"
      ...
      <div
        className="w-full"
        style={{ background: 'linear-gradient(180deg, #050510 0%, #1a1520 30%, #e8ddd0 70%, #FFF8F0 100%)', height: '120px' }}
